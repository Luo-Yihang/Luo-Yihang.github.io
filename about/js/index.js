...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        whoami_help: "Print the user name associated with the current effective user ID",
        ...
        welcome: "Congratulations!\n You have hacked the the terminal of Dark Hole. You can get more information about Luo Yihang. Try to type 'help' for the insturctions.",
        invalid_command_message: "<value>: command not found.",
        permission_denied_message: "Unable to '<value>', permission denied.",
        sudo_message: "Permission denied.",
        usage: "Usage",
        file: "file",
...
var main = (function () {
    ...
    Terminal.prototype.handleFill = function () {
        ...
        if ((cmdComponents.length <= 1) || (cmdComponents.length === 2 && cmdComponents[0] === cmds.CAT.value)) {
            ...
            if (possibilities.length === 1) {
                console.log(this.cmdLine.value)
    ...
    Terminal.prototype.whoami = function (cmdComponents) {
        var result = configs.getInstance().user + "\n";
        this.type(result, this.unlock.bind(this));
    };
    ...
    Terminal.prototype.reset = function () {
        ...
        if (this.typeSimulator) {
            this.type(configs.getInstance().welcome + "", function () {
                this.unlock();
            }.bind(this));
        }
    };
    ...
    TypeSimulator.prototype.type = function (text, callback) {
        ...
        output.innerHTML += (text.substring(0).replace(new RegExp("\n", 'g'), "<br/>")) + "<br/>";
        callback();
